...
namespace BookExchange.Infrastructure.persistance.migrations
{
    ...
    [Migration("20210426093729_Add Identity tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookExchange.Domain.Auth.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookExchange.Domain.Auth.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookExchange.Domain.Auth.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookExchange.Domain.Auth.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookExchange.Domain.Auth.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("BookExchange.Domain.Auth.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookExchange.Domain.Auth.UserToken", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookExchange.Domain.Models.BookBookCategory", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookExchange.Domain.Auth.RoleClaim", b =>
                {
                    b.HasOne("BookExchange.Domain.Auth.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookExchange.Domain.Auth.UserClaim", b =>
                {
                    b.HasOne("BookExchange.Domain.Auth.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookExchange.Domain.Models.BookBookCategory", b =>
                {
                    ...
                    b.HasOne("BookExchange.Domain.Models.BookCategory", "Category")
                        .WithMany()
